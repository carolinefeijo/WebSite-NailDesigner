        ...
        <div className='container-main' >
            ...
            <div className='aboute-container'>
                ...
                <div className='myStory-container'>
                    <h5>Liziane Silva</h5>
                    <span>Especialista em  Designer de Unhas</span>
                    <br />
                    <p>Olá, Queridas clientes!
                        <br />
                        Meu chamo Liziane, mãe de uma princesa e sou completamente apaixonada pela minha profissão.</p>
                    <br />
                    <p>Meu foco é atender com carinho e com dedicação cada cliente e priorizando sempre o melhor resultado. </p>
                    <p>Meu maior objetivo é fazer com que cada cliente se sinta ainda  mais bela  !</p>
                    <br />
