    ...
    return (
        <div className='gallery-component-container'>
            ...
            <div className='container-primary-imgs'>
                <img className='img-small' src={nail1} />
                <img className='img-medium' src={nail2} />
                <img className='img-small' src={nail3} />
            </div>

            <div className='container-secundary-imgs'>
                <img className='img-big' src={nail4} />


                <div className='container-tertiary-imgs'>
                    <img className='img-tertiary-medium' src={nail5} />
                    <img className='img-tertiary-big' src={nail6} />
                </div>
            </div>
        </div >
    )
